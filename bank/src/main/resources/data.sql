...
insert into customer values (6, "aleksa", "$2a$10$nG2PjMA09Mx/L5BiLdIfJ.y1O9B2fi5rBhYl8AfiCh3.lBwrc4ePG", "Aleksandar Markovljev");
...
insert into bank_account (id, pan, cardholder_name, expiration_date, service_code, balance, reserved, bank_id, customer_id)
values (2, "3333332222222222", "Marko Stevanov", '2020-04-20 00:00:00', "222", 10000, 0, 3, 2);

/* CASOPISI - RACUNI */
insert into bank_account (id, pan, cardholder_name, expiration_date, service_code, balance, reserved, bank_id, customer_id)
values (3, "1111113333333333", "Naucni kutak", '2020-05-20 00:00:00', "333", 10000, 0, 1, 3);
insert into bank_account (id, pan, cardholder_name, expiration_date, service_code, balance, reserved, bank_id, customer_id)
values (4, "2222224444444444", "Savremena psihologija", '2020-05-20 00:00:00', "444", 10000, 0, 2, 4);
insert into bank_account (id, pan, cardholder_name, expiration_date, service_code, balance, reserved, bank_id, customer_id)
values (5, "2222225555555555", "Nauka danas", '2020-05-20 00:00:00', "555", 10000, 0, 2, 5);

insert into bank_account (id, pan, cardholder_name, expiration_date, service_code, balance, reserved, bank_id, customer_id)
values (6, "3333335555555555", "Aleksandar Markovljev", '2020-05-20 00:00:00', "666", 1000, 0, 3, 6);